...
const Footer = () => {
  return (
    <footer className="bg-gray-900 text-gray-300 overflow-hidden" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 min-w-0">
          {/* Brand */}
          <div>
            <h2 className="sr-only">Aduke's Kitchen</h2>
            ...
            <div className="flex space-x-4">
              <a
                ...
                aria-label="Follow Aduke's Kitchen on TikTok"
              >
